...
// Depends on: global state, bestApAt, rssi, getAngleDependentGain, modelLoss, sinrAt, cciAt, countInterferingAntennas, throughputFromSinr
...
var CSVCoverageSystem = (function () {
  ...
  function getValueAt(x, y) {
    ...
    if (apToUse && typeof window.rssi === 'function' && typeof window.getAngleDependentGain === 'function' && typeof window.modelLoss === 'function') {
      bestN.ap = apToUse;
      bestN.rssiDbm = window.rssi(
        apToUse.tx,
        window.getAngleDependentGain(apToUse, x, y),
