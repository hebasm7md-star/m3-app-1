            ...
            if (csvValue !== null || (best && best.ap)) {
              ...
              if (csvValue !== null) {
                ...
                tooltipText =
                  ...
                  " " +
                  unit;
              } else if (best && best.ap || (state.optimizationRsrpGrid && state.view === "rssi")) {
                ...
                if (state.view === "rssi") {
                  value = val !== null ? val : (fallbackBest ? best.rssiDbm : -100);
                  unit = "dBm";
                  modeName = "RSSI";
                  ...
                  value = val !== null ? val : (fallbackBest ? throughputFromSinr(sinrAt(best.rssiDbm, cciAt(worldX, worldY, best.ap))) : 0);
                  unit = "Mbps";
                  modeName = "Throughput";
                  ...
                  value = fallbackBest ? best.ap.ch : "N/A";
                  unit = "";
                ...
                // Build tooltip text
                tooltipText = "Antenna: " + (fallbackBest ? best.ap.id : "System");
                if (value !== null) {
