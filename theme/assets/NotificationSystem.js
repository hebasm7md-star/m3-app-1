(function () {
  ...
  function deleteAntennaPattern(patternIndex) {
    ...
    var message = "<p><strong>Pattern:</strong> " + patternName + "</p>";
    if (usedByAntennas.length > 0) {
      message += "<p>Used by " + usedByAntennas.length + " antenna(s): " + usedByAntennas.join(", ") + "</p>";
      message += "<p style='color: #ef4444; font-weight: 500;'>These antennas will lose their pattern assignment.</p>";
    }
