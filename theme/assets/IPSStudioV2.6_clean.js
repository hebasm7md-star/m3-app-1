...
function draw() {
  ...
  /* AI COMMENT - addWall event listener moved to WallManager.js */
  ...
  /* AI COMMENT - elementType event listener moved to WallManager.js */

  /* AI COMMENT - wallsHelpModal event listeners moved to WallManager.js */

  /* AI COMMENT - floorPlane event listeners moved to FloorPlaneManager.js */

  /* AI COMMENT - wallType and customWallLoss event listeners moved to WallManager.js */
  ...
  /* AI COMMENT - floorPlaneAttenuation event listeners moved to FloorPlaneManager.js */
